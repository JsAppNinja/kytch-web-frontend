      ...
      <div className="row">
        <div className="col-lg-8 offset-lg-2">
          <h2 className="heading">
            <span className="gradient-blue">You've set up your account.
              <br className="d-none d-sm-block" />Now set up your kitchen.
            </span>
          </h2>
          <p>
          ...
          <p>To find out more about why we ask for this and how we use your information, go to &nbsp;
            <Link to="">kitch.com/privacy</Link>
            &nbsp;where you can access our <a href="">Privacy Statement</a>.</p>
          <div className="button-wrapper text-center mt-5">
            <Link className="btn btn-primary btn-min-width-long text-uppercase" to="setup_point_2">Continue</Link>
          </div>
        </div>
      </div>
    </div>
